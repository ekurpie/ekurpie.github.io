...
# Twitter API keys
API_KEY = 'tA7XkxxZk5yACbYOMICrj3QQr'
API_SECRET = 'gozBpjBYb8IwvThHytyHIYMhhJpoPIw0fnIcK3CTWeZvBr9EYW'
...
if __name__ == "__main__":
	...
	modes_of_research = {'UNCW': '@UNCW OR #UNCW OR UNCW OR @uncw OR #uncw OR uncw'}

	# location to store the target tweets
	save_location = os.path.join('files', 'UNCW2')
	...
	for mode, query in modes_of_research.items():
