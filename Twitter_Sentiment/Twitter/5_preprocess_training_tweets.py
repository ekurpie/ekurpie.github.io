...
if __name__ == "__main__":
	...
	db_collection = 'training_tweets_for_UNCW'
	...
	# 'manual': 'manual_tweets_raw' I manually removed this. add it back in in process sources if necessary

	# perform preprocessing on each training dataset
	for source, collection in process_sources.items():
